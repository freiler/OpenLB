...
#ifndef BLOCK_DYNAMIC_FIELDS_D_3D_H
#define BLOCK_DYNAMIC_FIELDS_D_3D_H
...
class BlockDynamicFieldsD3D : public BlockStructure3D, public Serializable {
private:
...
public:
  BlockDynamicFieldsD3D(int nX, int nY, int nZ);
  BlockDynamicFieldsD3D(): BlockDynamicFieldsD3D(1,1,1) { };
