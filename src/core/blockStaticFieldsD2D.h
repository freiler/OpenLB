...
#ifndef BLOCK_STATIC_FIELDS_D_2D_H
#define BLOCK_STATIC_FIELDS_D_2D_H
...
class BlockStaticFieldsD2D : public BlockStructure2D, public Serializable {
private:
...
public:
  BlockStaticFieldsD2D(int nX, int nY);
  BlockStaticFieldsD2D(): BlockStaticFieldsD2D(1,1) { };
