...
#ifndef BLOCK_STATIC_POPULATION_D_2D_H
#define BLOCK_STATIC_POPULATION_D_2D_H
 ...
 * provided by BlockStructure2D.
 **/
template<typename T, typename DESCRIPTOR>
class BlockStaticPopulationD2D : public BlockStructure2D, public Serializable {
private:
...
public:
  BlockStaticPopulationD2D(int nX, int nY);
  BlockStaticPopulationD2D() : BlockStaticPopulationD2D(1,1) { };
