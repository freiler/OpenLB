...
#ifndef SET_BOUZIDI_CONCENTRATION_BOUNDARY_H
#define SET_BOUZIDI_CONCENTRATION_BOUNDARY_H
...
template<typename T, typename DESCRIPTOR>
void setBouzidiConcentrationBoundary(BlockLatticeStructure3D<T, DESCRIPTOR>& block,BlockIndicatorF3D<T>& boundaryIndicator, BlockIndicatorF3D<T>& bulkIndicator,
