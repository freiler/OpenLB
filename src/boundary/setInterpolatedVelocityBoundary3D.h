...
#ifndef SET_INTERPOLATED_VELOCITY_BOUNDARY_H
#define SET_INTERPOLATED_VELOCITY_BOUNDARY_H
...
//This is an interpolated boundary therefore mostly --> MixinDynamics = BGKdynamics<T,DESCRIPTOR>>
template<typename T, typename DESCRIPTOR, typename MixinDynamics = BGKdynamics<T,DESCRIPTOR>>
void setInterpolatedVelocityBoundary(SuperLattice3D<T, DESCRIPTOR>& sLattice,T omega,
