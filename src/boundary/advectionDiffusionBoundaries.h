...
//===================================================================================
template<typename T, typename DESCRIPTOR, typename Dynamics, int direction, int orientation>
class AdvectionDiffusionEnthalpyBoundariesDynamics : public TotalEnthalpyAdvectionDiffusionBGKdynamics<T,DESCRIPTOR> {
public:
  /// Constructor
...
//===================================================================================
template<typename T, typename DESCRIPTOR, typename Dynamics, int plane, int normal1, int normal2>
class AdvectionDiffusionEnthalpyEdgesDynamics : public TotalEnthalpyAdvectionDiffusionBGKdynamics<T,DESCRIPTOR> {
public:
  /// Constructor
  AdvectionDiffusionEnthalpyEdgesDynamics(T omega_, Momenta<T,DESCRIPTOR>& momenta_, T T_s_, T T_l_, T cp_s_, T cp_l_, T lambda_s_, T lambda_l_, T l_);
  /// Compute equilibrium distribution function
  T computeEquilibrium(int iPop, T rho, const T u[DESCRIPTOR::d], T uSqr) const override;
  /// Collision step
  void collide(Cell<T,DESCRIPTOR>& cell, LatticeStatistics<T>& statistics) override;
...
//===================================================================================
template<typename T, typename DESCRIPTOR, typename Dynamics, int xNormal, int yNormal, int zNormal>
class AdvectionDiffusionEnthalpyCornerDynamics3D : public TotalEnthalpyAdvectionDiffusionBGKdynamics<T,DESCRIPTOR> {
public:
  /// Constructor
  AdvectionDiffusionEnthalpyCornerDynamics3D(T omega_, Momenta<T,DESCRIPTOR>& momenta_, T T_s_, T T_l_, T cp_s_, T cp_l_, T lambda_s_, T lambda_l_, T l_);
  /// Compute equilibrium distribution function
  T computeEquilibrium(int iPop, T rho, const T u[DESCRIPTOR::d], T uSqr) const override;
  /// Collision step
  void collide(Cell<T,DESCRIPTOR>& cell, LatticeStatistics<T>& statistics) override;
