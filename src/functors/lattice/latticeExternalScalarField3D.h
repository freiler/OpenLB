...
public:
  SuperLatticeExternalScalarField3D(SuperLattice3D<T,DESCRIPTOR>& sLattice);
};
...
public:
  BlockLatticeExternalScalarField3D(BlockLatticeStructure3D<T,DESCRIPTOR>& blockLattice);
