...
#ifndef BLOCK_ROUNDING_F_3D_HH
#define BLOCK_ROUNDING_F_3D_HH
...
template <typename T>
BlockRoundingF3D<T>::BlockRoundingF3D(BlockF3D<T>& f,
...
template <typename T>
bool BlockRoundingF3D<T>::operator()(T output[], const int input[])
{
